...
//       const options = {
//         key: "rzp_test_RtCgv5KljKQq15", // Replace with your Razorpay Key ID
...
//   };
  ...
  try {
    ...
    console.log("Sending payment request to backend:", requestBody);
    ...
    if (!response.ok) {
      ...
      console.error("Failed to create Razorpay order:", errorText);
    ...
    const options = {
      key: "rzp_test_RtCgv5KljKQq15", // Test key
