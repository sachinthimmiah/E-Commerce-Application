...
//	Fetches all successful orders for a given user and returns the required response format. @param user The authenticated user object. @return A map containing the user's role, username, and ordered products. /
